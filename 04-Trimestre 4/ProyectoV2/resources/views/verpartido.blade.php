...
<div class="container-fluid">
  ...
  <a href="{{url('crearpartido')}}"><button type="button" class="btn btn-logout btn-outline-primary">Crear partido</button></a>
    ...
    <table class="table table-striped">
      ...
      @foreach ($partido as $item)
        <tr>
          ...
          <td><a href="{{ route('partido.edit', ['id_partido' => $item->id_partido]) }}"><button type="button" class="btn btn-logout btn-outline-primary">Editar</button></a></td>
