...
<div class="container-fluid">
  ...
  <a href="{{url('creartest')}}"><button type="button" class="btn btn-logout btn-outline-primary">Crear test</button></a>
  <a href="{{url('/vertest/testpdf')}}"><button type="button" class="btn btn-logout btn-outline-primary">Ver reporte test</button></a>
    ...
    <table class="table table-striped">
      ...
      @foreach ($test as $item)
        <tr>
          ...
          <td><a href="{{ route('test.edit', ['id_test' => $item->id_test]) }}"><button type="button" class="btn btn-logout btn-outline-primary">Editar</button></a></td>
