...
<div class="container-fluid">
  ...
  <a href="{{url('/listaperfiles/perfilpdf')}}"><button type="button" class="btn btn-logout btn-outline-primary">Ver reporte perfiles</button></a>
    ...
    <table class="table table-striped">
      ...
      @foreach ($perfil as $item)
        <tr>
          <td>{{$item->nombre}}</td>
          <td>{{$item->email}}</td>
          <td><a href="{{ route('perfil.index', ['id_perfil' => $item->id_perfil]) }}"><button type="button" class="btn btn-logout btn-outline-primary">Ver perfil</button></a></td>
        </tr>
        @endforeach
