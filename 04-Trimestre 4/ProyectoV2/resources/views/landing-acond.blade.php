      ...
      <div class="contenido container pt-1 pt-md-5">
        <div class="row">
            <div class="col-md-6 col-lg-5">
                <h1 class="title display-4">Acondicionamiento físico</h1>
                <p class="text lead">El acondicionamiento físico que brinda club leones busca determinar el nivel de los interesados y establecer un plan acorde a sus necesidades.
                </p>
            </div>
