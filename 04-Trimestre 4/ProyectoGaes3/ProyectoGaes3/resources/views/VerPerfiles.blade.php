    ...
    <div class="dashboard"><!-- Aquí empieza el codigo del menu lateral -->
        ...
        <div class="contenido">
            <div class="contenido1">
              <h1 class="title">Ver Perfiles</h1>
                ...
                <div class="col-sm ml-auto">
                    <table>
                          ...
                          <tr>
                            ...
                            <tr>
                              <td>Julian David Gamba Herrera <button type="button" class="btn btn-primary btn-lg"><a class="textobtn" href="{{url('/Perfil')}}">Ver Perfil</a></button>
                              </td>
                             
                            </tr>
                            <tr>
                              <td>Daniel Esteban Parra Castillo<button type="button" class="btn btn-primary btn-lg"><a class="textobtn" href="{{url('/Perfil')}}">Ver Perfil</a></button></td>
                             
                            </tr>
                            <tr>
                              <td>Freddy Alejandro Noy<button type="button" class="btn btn-primary btn-lg"><a class="textobtn" href="{{url('/Perfil')}}">Ver Perfil</a></button></td>
                           
                            </tr>
                            <tr>
                              <td>Julian Esteban Noy Castillo<button type="button" class="btn btn-primary btn-lg"><a class="textobtn" href="{{url('/Perfil')}}">Ver Perfil</a></button></td>
                          
                            </tr>
                            <tr>
                              <td>Daniel Alejandro Castillo Gamba<button type="button" class="btn btn-primary btn-lg"><a class="textobtn" href="{{url('/Perfil')}}">Ver Perfil</a></button></td>
            ...
            <ion-icon name="ion-plus"></ion-icon>
</body>
</html>