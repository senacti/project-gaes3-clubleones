        ...
        <form action="/formulario" method="GET">
          ...
          <div class="col-sm ml-auto">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <div class="list-group">
                          <a href="../Campeonatos/ActualizarDatos.html" class="list-group-item list-group-item-action">Actualizar Datos</a>
                          <a href="../Campeonatos/AgregarJugador.html" class="list-group-item list-group-item-action">Agregar Jugador</a>
                          <a href="#" class="list-group-item list-group-item-action">Eliminar Equipo</a>
