              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input value="" type="number" id="puntuaciónmin" name="puntuaciónmin" placeholder=""/>
                    </td>
                    <td>
                      <input value="" type="number" id="puntuaciónmax" name="puntuaciónmax" placeholder=""/>
                    </td>
                    <td>
                      <input value="" type="number" id="Identificación" name="Identificación" placeholder=""/>
                    </td>
                    <td>
                        <input value="" type="number" id="bajo" name="bajo" placeholder=""/>
                      </td>
