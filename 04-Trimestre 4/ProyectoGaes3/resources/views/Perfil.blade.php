...
<div class="todo">
    <div class="dashboard"><!-- Aquí empieza el codigo del menu lateral -->
        ...
        <div class="contenido">
          ...
          <div class="botonedit">
            <button type="button" class="btn btn-primary btn-lg"><a class="textobtn" href="..Perfil.html">Editar</a></button>
    </div>
            </div>
