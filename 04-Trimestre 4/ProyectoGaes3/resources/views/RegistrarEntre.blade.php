...
<div class="todo">
    ...
    <div class="contenido">
      <div class="contenido1">
        <h1 class="title">Registrar entrenamiento</h1>
          ...
          <div class="col-sm ml-auto">
              <table>
                ...
                <tbody>
                  ...
                  <a class="nav-link" href="../Errores/Error404.html"><button class="boton" type="submit">Agregar</button></a>
                  <a class="nav-link" href="../Errores/Error404.html"><button class="boton" type="submit">Editar</button></a>
                  <a class="nav-link" href="../Errores/Error404.html"><button class="boton" type="submit">Eliminar</button></a>
                  <tr>
                    <td>30 Marzo</td>
                    <td>10:00 AM</td>
                    <td>Resistencia</td>
                    <td>Entrenamiento enfocado en la resistencia de los jugadores</td>
                  ...
                  <tr>
                    <td>31 Marzo</td>
                    <td>11:00 AM</td>
                    <td>Control de balon</td>
                    <td>Entrenamiento enfocado en mejorar el control del balon</td>
                  ...
                  <tr>
                    ...
                    <td>5:00 PM</td>
                    <td>Tiro al arco</td>
                    <td>Entrenamiento enfocado los tiros al arco</td>
