...
<div class="todo">
    ...
    <div class="contenido">
      <div class="contenido1">
        <h1 class="title">Crear campeonato</h1>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th>Color Equipación</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  </tr>
                  <button class="boton" type="button"><a href="../Campeonatos/AgregarEquipo.html">Agregar Equipo</a></button>
                  <button class="boton" type="submit"><a href="../Campeonatos/EditarEquipo.html">Editar Equipo</a></button>
                  <tr>
                    <td>Real Madrid</td>
                    <td>Juvenil</td>
                    <td>Si</td>
