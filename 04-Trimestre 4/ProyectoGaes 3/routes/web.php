...
Route::get('/verprogramacion/programacionpdf', [App\Http\Controllers\CrudProgramacionController::class, 'pdf'])->name('programacion.pdf');
...
Route::get('/verjugador/jugadorpdf', [App\Http\Controllers\CrudJugadorController::class, 'pdf'])->name('jugador.pdf');
...
Route::get('/verpartido/partidopdf', [App\Http\Controllers\CrudPartidoController::class, 'pdf'])->name('partido.pdf');
...
Route::get('/verejercicio/ejerciciopdf', [App\Http\Controllers\CrudEjercicioController::class, 'pdf'])->name('ejercicio.pdf');
...
// Ruta para mostrar el formulario de creación de un ejercicio
...
Route::get('/verentrenamiento/entrenamientopdf', [App\Http\Controllers\CrudEntrenamientoController::class, 'pdf'])->name('entrenamiento.pdf');
