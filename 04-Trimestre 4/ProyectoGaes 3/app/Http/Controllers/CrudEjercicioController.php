...
class CrudEjercicioController extends Controller
{
    ...
    public function pdf(){
        ...
        $pdf = Pdf::loadView('ejerciciopdf', compact('ejercicio'));
        return $pdf->stream();
    }
...
public function create(Request $request, $id_planacondicionamiento)
{
    ...
    $ejercicio->save();
    return redirect()->route('ejercicio.index', ['id_planacondicionamiento' => $planacondicionamiento->id_planacondicionamiento])->with('planacondicionamiento', $planacondicionamiento);
}
