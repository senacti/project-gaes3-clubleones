...
{{-- html del contenido de la páginaa --}}
        ...
        <div class="container">
            <h1 class="text-center">Crear Entrenamiento</h1>
            <form action="{{route("entrenamiento.create")}}" method="post">
              @csrf
              <div class="row">
              ...
              <div class="mb-3 fondo2">
                <label for="tipo_entrenamiento" class="form-label fondo2">Tipo de entrenamiento</label>
