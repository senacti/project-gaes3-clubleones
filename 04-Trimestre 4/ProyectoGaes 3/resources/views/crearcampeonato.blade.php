...
{{-- html del contenido de la páginaa --}}
        ...
        <div class="container">
            ...
            <form action="{{route("campeonato.create")}}" method="post">
              @csrf
             <div class="row">
              <div class="col-md-12 fondo2">
              <div class="mb-3 fondo2">
                <label for="nombreCampeonato" class="form-label fondo2">Nombre del Campeonato</label>
              ...
              <div class="mb-3 fondo2">
                <label for="modo" class="form-label fondo2">Modo</label>
              ...
              <div class="mb-3 fondo2">
                <label for="precio_inscripcion" class="form-label fondo2">Precio de Inscripción</label>
                <input type="number" class="form-control" id="precio_inscripcion" name="precio_inscripcion" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="valor_premiacion" class="form-label fondo2">Valor de Premiación</label>
                <input type="number" class="form-control" id="valor_premiacion" name="valor_premiacion" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="cantidad_equipos" class="form-label fondo2">Cantidad de Equipos</label>
                <input type="number" class="form-control" id="cantidad_equipos" name="cantidad_equipos" required>
              </div>
              <div class="mb-3 fondo2">
