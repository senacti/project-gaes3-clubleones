...
{{-- html del contenido de la páginaa --}}
        ...
        <div class="container">
            ...
            <form action="{{route("jugador.create", ['id_equipo' => $id_equipo])}}" method="POST">
              ...
              <div class="mb-3 fondo2">
                <label for="identificacion" class="form-label fondo2">Identificación</label>
                <input type="number" class="form-control" id="identificacion" name="identificacion" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="dorsal" class="form-label fondo2">Dorsal</label>
                <input type="number" class="form-control" id="dorsal" name="dorsal" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="edad" class="form-label fondo2">Edad</label>
                <input type="number" class="form-control" id="edad" name="edad" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="numero_contacto" class="form-label fondo2">Número de contacto</label>
                <input type="number" class="form-control" id="numero_contacto" name="numero_contacto" required>
              </div>   
              {{-- <div class="mb-3 fondo2">
                <label for="id_equipo" class="form-label fondo2">id_equipo</label>
