...
<div class="container-fluid">
  ...
  <a href="{{url('crearplanacondicionamiento')}}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Crear plan de acondicionamiento</button></a>
  <a href="{{url('/verplanacondicionamiento/planacondicionamientopdf')}}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Ver reporte plan acondicionamiento</button></a>
  <div class="table-responsive pt-3">
    <table class="table table-striped">
      ...
      @foreach ($planacondicionamiento as $item)
        <tr>
          <td><a href="{{ url('verejercicio', ['id_planacondicionamiento' => $item->id_planacondicionamiento]) }}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Ejercicios</button></a></td>  
          ...
          <td><a href="{{ route('planacondicionamiento.edit', ['id_planacondicionamiento' => $item->id_planacondicionamiento]) }}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Editar</button></a></td>
          <td><form action="{{ route('planacondicionamiento.delete', ['id_planacondicionamiento' => $item->id_planacondicionamiento]) }}" method="post">
  @method("delete")
  @csrf
