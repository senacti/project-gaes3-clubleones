...
<div class="container-fluid">
  ...
  <a href="{{ route('ejercicio.createform', ['id_planacondicionamiento' => $id_planacondicionamiento]) }}">
    <button type="button" class="opciones btn btn-logout btn-outline-primary">Crear Ejercicio</button>
</a>
<a href="{{url('/verejercicio/ejerciciopdf')}}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Ver reporte ejercicio</button></a>
    ...
    <table class="table table-striped">
      ...
      @foreach ($ejercicio as $item)
        <tr>
          ...
          <td><a href="{{ route('ejercicio.edit', ['id_ejercicio' => $item->id_ejercicio]) }}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Editar</button></a></td>
