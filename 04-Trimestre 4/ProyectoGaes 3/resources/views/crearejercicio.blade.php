...
{{-- html del contenido de la páginaa --}}
        ...
        <div class="container">
            ...
            <form action="{{route("ejercicio.create", ['id_planacondicionamiento' => $id_planacondicionamiento])}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3 fondo2">
                <label for="imagen" class="form-label fondo2">Imagen</label>
                <input type="file" class="form-control" id="imagen" name="imagen" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="descripcion" class="form-label fondo2">Descripcion</label>
                <input type="text" class="form-control" id="descripcion" name="descripcion" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="cantidad" class="form-label fondo2">Cantidad</label>
                <input type="number" class="form-control" id="cantidad" name="cantidad" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="segundos" class="form-label fondo2">Segundos</label>
                <input type="number" class="form-control" id="segundos" name="segundos" required>
              </div>   
              <div class="mb-3 fondo2">
                <label for="id_planacondicionamiento" class="form-label fondo2">id_planacondicionamiento</label>
