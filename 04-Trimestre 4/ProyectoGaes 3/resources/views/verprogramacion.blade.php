...
<head>
    ...
    <title>Club Leones programación</title>
</head>
<body class="body">
<!-- html de la navbar -->
    <div class="header">
...
<div class="container-fluid">
  ...
  <a href="{{url('crearprogramacion')}}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Crear programación</button></a>
  <a href="{{url('/verprogramacion/programacionpdf')}}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Ver reporte programación</button></a>
    ...
    <table class="table table-striped">
      ...
      @foreach ($programacion as $item)
        ...
        <tr>
          ...
          <td><a href="{{ route('programacion.edit', ['id_programacion' => $item->id_programacion]) }}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Editar</button></a></td>
