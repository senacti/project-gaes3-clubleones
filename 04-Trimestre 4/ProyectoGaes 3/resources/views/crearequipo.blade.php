...
{{-- html del contenido de la páginaa --}}
        ...
        <div class="container">
            ...
            <form action="{{route("equipo.create")}}" method="POST">
              @csrf
              <div class="row">
              ...
              <div class="mb-3 fondo2">
                <label for="color_equipacion" class="form-label fondo2">Color de la equipación</label>
                <input type="text" class="form-control" id="color_equipacion" name="color_equipacion" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="color_equipacion2" class="form-label fondo2">Color de la equipación 2</label>
                <input type="text" class="form-control" id="color_equipacion2" name="color_equipacion2" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="cantidad_jugadores" class="form-label fondo2">Cantidad de jugadores</label>
                <input type="number" class="form-control" id="cantidad_jugadores" name="cantidad_jugadores" required>
              </div>
              <div class="mb-3 fondo2">
                <label for="pago_inscripcion" class="form-label fondo2">Pago de inscripción</label>
                <input type="text" class="form-control" id="pago_inscripcion" name="pago_inscripcion" required>
              </div>   
              <div class="mb-3 fondo2">
