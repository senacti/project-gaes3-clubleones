...
<div class="container-fluid">
  ...
  <a href="{{url('/listaperfiles/perfilpdf')}}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Ver reporte perfiles</button></a>
  <div class="table-responsive pt-4">
    <table class="table table-striped">
      <thead>
        <tr class="fila1listaperfil" >
      ...
      @foreach ($perfil as $item)
        <tr class="fila2listaperfil" >
          <td>{{$item->nombre}}</td>
          <td>{{$item->email}}</td>
          <td><a href="{{ route('perfil.index', ['id_perfil' => $item->id_perfil]) }}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Ver perfil</button></a></td>
        </tr>
        @endforeach
