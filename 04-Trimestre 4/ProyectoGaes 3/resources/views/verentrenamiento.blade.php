...
<head>
    ...
    <title>Club Leones entrenamientos</title>
</head>
<body class="body">
<!-- html de la navbar -->
    <div class="header">
...
<div class="container-fluid">
  ...
  <a href="{{url('crearentrenamiento')}}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Crear entrenamiento</button></a>
  <a href="{{url('/verentrenamiento/entrenamientopdf')}}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Ver reporte entrenamiento</button></a>
    ...
    <table class="table table-striped">
      ...
      @foreach ($entrenamiento as $item)
        <tr>
          ...
          <td><a href="{{ route('entrenamiento.edit', ['id_entrenamiento' => $item->id_entrenamiento]) }}"><button type="button" class="opciones btn btn-logout btn-outline-primary">Editar</button></a></td>
